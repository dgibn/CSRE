...
from model_LN_prompt import Model
from dataset_retrieval import Sketchy
...
if __name__ == '__main__':
    ...
    val_dataset = Sketchy(opts, dataset_transforms, mode='test', used_cat=train_dataset.all_categories, return_orig=False)
